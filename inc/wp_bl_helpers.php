...
if(! class_exists( 'BL_Helper_v2' )) {
    class BL_Helper_v2
    {
         ...
         * Usage: fancy-book-cover_write_log( "The variable value is: $variable");
    ...
    if(! class_exists( 'BL_Helper' )) {
        class BL_Helper extends BL_Helper_v2 {
