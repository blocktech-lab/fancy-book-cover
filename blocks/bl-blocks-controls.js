    ...
    return el(Panel, {}, el(PanelBody, {
        ...
        el(BaseControl, {
            ...
            el(PanelRow, {},
                el('div', {
                    ...
                    }, [ __( 'No posts selected', 'fancy-book-cover' ) ]),
        ...
        isVisible && el(Popover, {
            ...
            el(LinkControl, {
                ...
                noDirectEntry: true,
                searchInputPlaceholder: __('Select a post', 'fancy-book-cover'),
    ...
    return el(Panel, {
            ...
            el(MediaUploadCheck, {}, [
                el(MediaUpload, {
                    ...
                    render: (open) => el(Button, {
                        ...
                        (getUrl() === '' && getSVG() === '') &&__('Select an image', 'fancy-book-cover'),
        ...
        inline_svg && !getUrl() && !getSVG() && el(PanelRow, {}, [
            el(Button, {
                ...
                __('Set inline SVG', 'fancy-book-cover')
            ]),
        ]),
        ...
        (getUrl() || getSVG()) && el(PanelRow, {}, [
            el(MediaUploadCheck, {}, [
                el(MediaUpload, {
                    title: __('Replace image', 'fancy-book-cover' ),
                    onSelect: onSelectMedia,
                    value: getId(),
                    allowedTypes: ['image'],
                    render: (open) => el(Button, {
                        ...
                        __('Replace image', 'fancy-book-cover'),
                    ])
            ...
            el(Button, {
                ...
                __('Remove image', 'fancy-book-cover')
            ])
        ]),
        ...
        isEditSVGVisible.visible && el(Popover, {
            ...
            el(BaseControl, {}, [
                el(TextareaControl, {
                    value: getSVG(),
                    help: __( 'Paste or edit the SVG image code.', 'fancy-book-cover' ),
                    label: __( 'Edit inline SVG', 'fancy-book-cover' ),
    ...
    return el(BaseControl, {
        ...
        el(PanelRow, {}, [
            el(Button, {
                ...
                el('span', {}, __( title || 'Select color', 'fancy-book-cover' )),
                el('span', {
                    style: {
    ...
    return el(BaseControl, {
        ...
        el(PanelRow, {}, [
            el(Button, {
                ...
                !props.attributes[prop].url && el('span', {}, __('Select link', 'fancy-book-cover')),
        ...
        isVisible && el(Popover, {}, [
            el('div', {
                ...
                el(SelectControl, {
                    ...
                    label: __( 'Post type', 'fancy-book-cover' ),
...
function PgGetServerSideRender() {
    ...
    function DefaultEmptyResponsePlaceholder( { className } ) {
        return el(Placeholder, { className: className}, __( 'Block rendered as empty.', 'fancy-book-cover' ));
    }

    function DefaultErrorResponsePlaceholder( { response, className } ) {
        const errorMessage = sprintf(
            // translators: %s: error message describing the problem
            __( 'Error loading block: %s', 'fancy-book-cover' ),
            response.errorMsg
        );
