<?php
BL_Blocks::register_block_type( array(
    'name' => 'fancy-book-cover/book',
    'title' => __( 'Fancy Book Cover', 'fancy-book-cover' ),
    'description' => __( 'A 3D book cover animated on hover.', 'fancy-book-cover' ),
    ...
    'enqueue_style' => COVER_URL . '/assets/style-min.css',
    ...
    'attributes' => array(
        ...
        'book_cover_img' => array(
            'type' => 'object',
            'default' => array('id' => 0, 'url' => esc_url( COVER_URL . '/assets/cover.png' ), 'size' => '', 'svg' => '', 'alt' => null)
        )
    ),
    'example' => array(
        'book_cover_link' => array('post_id' => 0, 'url' => '#void', 'post_type' => '', 'title' => ''), 'book_size' => 'big', 'back_cover_text' => __( 'Buy', 'fancy-book-cover'), 'back_cover_icon_type' => 'download', 'back_cover_color' => '', 'back_cover_bkg_color' => '', 'book_cover_img' => array('id' => 0, 'url' => esc_url( COVER_URL . '/assets/cover.png' ), 'size' => '', 'svg' => '', 'alt' => null)
    ),
    'dynamic' => true,
    'version' => '0.4.0',
    'api_version' => '3'
